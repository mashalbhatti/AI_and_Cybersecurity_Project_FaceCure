...
from fawkes3.fawkes.align_face import aligner
from fawkes3.fawkes.utils import init_gpu, load_extractor, load_victim_model, preprocess, Faces, filter_image_paths
...
class DataGenerator(object):
    def __init__(self, original_images, protect_images, cloak_frac=1.0, aligner=None):
        ...
        for cur_data_dir in select_data_dir:
            ...
            all_pathes = glob.glob(os.path.join(cur_data_dir + "/face/", "*.jpeg"))
...
def main():
    ...
    model.fit_generator(train_generator, steps_per_epoch=500, # 500,
