...
class Fawkes(object):
    ...
    def run_protection(self, image_paths, output_directory, th=0.04, sd=1e7, lr=10, max_step=500, batch_size=1, format='png',
        ...
        for i in range(len(final_images)):
            ...
            #dump_image(p_img, output_path, format=format)
...
def main(*argv):
    ...
    parser.add_argument('--output', '-o', type=str,
                        help='the directory to save protected images', default='output/')
    ...
    protector.run_protection(image_paths, output_directory=args.output, th=args.th, sd=args.sd, lr=args.lr,
